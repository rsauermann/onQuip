...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form name="stornieren.php" action="" method="" style="rein">
		          <div align="center">
					...
					<?php
						...
						if( isset($_POST["stornieren"]) ) {
                            ...
                            $sql = "DELETE FROM reservierungen WHERE id='". $_POST['id'] ."' AND von='". $_POST['von'] ."' AND bis='". $_POST['bis'] ."' AND schueler='". $_POST['schueler'] ."';";

							if ($conn->query($sql) === TRUE) {
								echo "Reservierung wurde storniert!";
							} else {
