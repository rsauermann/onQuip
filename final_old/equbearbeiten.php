...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form action="equipment_bearbeiten.php" method="post" style="rein">
		    <div align="center">
                ...
                <p/>
                <div>
					<h3>Zu bearbeitendes Equipment:</h3><br/>
                    Inventarnummer: <input type="text" name="equipmentin" value="<?php if (isset($_POST['equipmentin'])) echo $_POST['equipmentin']; ?>"><br>
                    Seriennummer: <input type="text" name="equipmentsn" value="<?php if (isset($_POST['equipmentsn'])) echo $_POST['equipmentsn']; ?>"><br>
                    Bezeichnung: <input type="text" name="bezeichnung" value="<?php if (isset($_POST['bezeichnung'])) echo $_POST['bezeichnung']; ?>"><br>
					<h3>Zu &aumlndernde Equipment Daten:</h3><br/>
                    Inventarnnummer: <input type="text" name="equipmentinneu" value="<?php if (isset($_POST['equipmentinneu'])) echo $_POST['equipmentinneu']; ?>"><br>
                    Seriennummer: <input type="text" name="equipmentsnneu" value="<?php if (isset($_POST['equipmentsnneu'])) echo $_POST['equipmentsnneu']; ?>"><br>
                    Bezeichnung: <input type="text" name="bezeichnungneu" value="<?php if (isset($_POST['bezeichnungneu'])) echo $_POST['bezeichnungneu']; ?>"><br>
                    Kategorie: <input type="text" name="kategorie" value="<?php if (isset($_POST['kategorie'])) echo $_POST['kategorie']; ?>"><br>
                    Bild: <input type="text" name="bild" value="<?php if (isset($_POST['bild'])) echo $_POST['bild']; ?>"><br>
                    Zustand: <input type="text" name="zustand" value="<?php if (isset($_POST['zustand'])) echo $_POST['zustand']; ?>"><br>
					Beschreibung: <input type="text" name="beschreibung" value="<?php if (isset($_POST['beschreibung'])) echo $_POST['beschreibung']; ?>"><br>
					<!--<textarea autofocus maxlength="500" rows="5" cols="30" name="beschreibung" value=""></textarea><br>-->
