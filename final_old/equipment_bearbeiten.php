...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form name="equipment_bearbeiten.php" action="" method="" style="rein">
		          <div align="center">
					...
					<?php
						...
						if( isset($_POST["entfernen"]) ) {
							...
							SET inventarnummer='". $_POST['equipmentinneu'] ."' , seriennummer='". $_POST['equipmentsnneu'] ."' , bezeichnung='". $_POST['bezeichnungneu'] ."' , beschreibung='". $_POST['beschreibung'] ."' , kategorie='". $_POST['kategorie'] ."' , bild='". $_POST['bild'] ."' , zustand='". $_POST['zustand'] ."' 
							 WHERE inventarnummer='". $_POST['equipmentin'] ."' AND seriennummer='". $_POST['equipmentsn'] ."';";
							
							echo "Holleridudeldu";
							
							//$sql2 = "UPDATE reservierungen
							//SET equipmentsn='". $_POST['equipmentsnneu'] ."' WHERE equipmentsn='". $_POST['equipmentsn'] ."';";
							
							if ($conn->query($sql) === TRUE) {
								echo "Equipment wurde bearbeitet!";
							} else {
