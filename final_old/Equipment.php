...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form name="equipment.php" action="" method="" style="rein">
			<div align="center">
				<h1>onQuip</h1>
				...
				<div id="table" class="wrapper">
					<?php
						...
						$queryreservierungen= 'SELECT * FROM equipment;';
										...
										echo '<div class="panel panel-default">';
											echo '<div class="panel-body">';
												echo '<div class="col-xs-8">';
													echo '<div class="panel panel-default">';;
														echo '<div class="panel-heading gruen">';
												...
												echo '<div class="col-xs-6">';
													echo '<div class="row">';
														echo '<div class="panel panel-default">';
															...
															echo '</div>';
														echo '</div>';
														echo '<div class="col-xs-4 col-xs-offset-7">';
															echo '<div class="row">';
																echo '<div class="panel panel-default">';
																	echo '<div class="panel-button">';
																		echo '<a href="reserstellen.php">Reservieren</a>';
																	echo '</div>';
																echo '</div>';
															echo '</div>';
														echo '</div>';
