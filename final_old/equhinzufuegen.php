...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form action="equipment_erstellen.php" method="post" style="rein">
		    <div align="center">

    			<p/>
    			<h1>Equipment hinzuf&uuml;gen </h1>
                <p/>
                <div>
                    Inventarnnummer: <input type="text" name="equipmentin" value="<?php if (isset($_POST['equipmentin'])) echo $_POST['equipmentin']; ?>"><br>
