...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form action="stornieren.php" method="post" style="rein">
		    <div align="center">
                ...
                <p/>
                <div>
                    Reservierungs-ID: <input type="text" name="id" value="<?php if (isset($_POST['id'])) echo $_POST['id']; ?>"><br>
                    Ausleihdatum: <input type="text" name="von" value="<?php if (isset($_POST['von'])) echo $_POST['von']; ?>"><br>
                    R&uuml;ckgabedatum: <input type="text" name="bis" value="<?php if (isset($_POST['bis'])) echo $_POST['bis']; ?>"><br>
                    Name(abk.): <input type="text" name="schueler" value="<?php if (isset($_POST['schueler'])) echo $_POST['schueler']; ?>"><br>
                    <button type="submit" name="stornieren">Stornieren</button>
                </div>
    		</div>
		</form>
