...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form name="reservieren.php" action="" method="" style="rein">
		          <div align="center">
					...
					<?php
						...
						if( isset($_POST["anlegen"]) ) {
							...
							$sql = "INSERT INTO reservierungen (equipmentsn, von, bis, schueler, telefonnr, lehrerabholen, lehrerrueck, zweck) VALUES ('"
								. $_POST['equipmentsn'] ."', '"
								. $_POST['von'] ."', '"
								. $_POST['bis'] ."', '"
								. $_POST['schueler'] ."', '"
								. $_POST['telefonnr'] ."', '"
								. "tree" . "', '" //. $_POST['lehrerabholen'] ."', '" // weil tree fuers erste als default
								. "tree" ."', '" //. $_POST['lehrerrueck'] ."', '" // weil tree fuers erste als default
								. $_POST['zweck'] ."');";

							if ($conn->query($sql) === TRUE) {
								echo "Reservierung wurde erstellt!";
							} else {
								echo "Fehler beim Reservieren: " . $conn->error;
							}
