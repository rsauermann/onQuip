...
<html>
	...
	<body style="background: url(img/bg.jpg) no-repeat center center fixed;
		...
		<form name="equipment_erstellen.php" action="" method="" style="rein">
		          <div align="center">
					...
					<?php
						...
						if( isset($_POST["anlegen"]) ) {
							...
							$sql = "INSERT INTO equipment (inventarnummer, seriennummer, bezeichnung, beschreibung, kategorie, bild, zustand) VALUES ('"
								. $_POST['equipmentin'] ."', '"
								. $_POST['equipmentsn'] ."', '"
								. $_POST['bezeichnung'] ."', '"
								. $_POST['beschreibung'] ."', '"
							...
							if ($conn->query($sql) === TRUE) {
								echo "Equipment wurde erfolgreich erstellt!";
							} else {
								echo "Fehler beim Anlegen des Equipments: " . $conn->error;
							}
